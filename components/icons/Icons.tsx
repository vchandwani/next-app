  ...
  switch (name) {
    ...
    case "audience":
      return (
        <svg {...iconProps} viewBox="0 0 20 20">
          <path
            d="M7.02061 11.0049H13.0234V9.00488H15.0229V3.00103H13.0234V1.00488H7.02061V3.00488H5.02399V9.00873H7.02061V11.0049ZM13.0229 3.00488V9.00488H7.02399V3.00488H13.0229Z"
            strokeWidth="1.5"
          />
          <path
            d="M17.0234 13.0049V11.0064H15.0234V13.0064H17.0234V17.0049H3.02344V13.0049H5.02344V11.0049H3.02344V13.0034H1.02344V19.0049H19.0234V13.0049H17.0234Z"
            strokeWidth="1.5"
          />
        </svg>
      );
    ...
    case "file":
      return (
        <svg {...iconProps} viewBox="0 0 16 16">
          <path
            d="M14.5 13.5V5.41a1 1 0 0 0-.3-.7L9.8.29A1 1 0 0 0 9.08 0H1.5v13.5A2.5 2.5 0 0 0 4 16h8a2.5 2.5 0 0 0 2.5-2.5ZM13 13.5a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1v-12h5v5h5V13.5ZM9.5 5V2.12L12.38 5H9.5ZM5.13 5h-.62v1.25h2.12V5H5.13ZM4.5 8h7.12v1.25H4.5V8ZM5.13 11h-.62v1.25h7.12V11H5.13Z"
            fill="currentColor"
            fillRule="evenodd"
            clipRule="evenodd"
          />
